...
Virtualizační techniku Solaris Zones je možné zařadit v klasifikaci virtuálních strojů popsané v kapitole \ref{section:clasification}
...
Zóny, které jsou spouštěny v rámci globální zóny se nazývají \textbf{neglobální} zóny. Tyto zóny jsou navzájem izolované na
...
sdílené části souborového systému jsou tyto části připojeny v režimu read-only \cite{cvut:presentation:virt11}. Tím je zajištěno,
