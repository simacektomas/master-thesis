...
se standardně myslí operační systém. Servery je možné rozdělit dle typu běžících uživatelských programů v~operačním systému.
...
bezpečnosti a zjednodušení správy celého systému. Tyto výhody pramení především z~centralizace tohoto řešení.  
