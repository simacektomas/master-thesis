...
\begin{table}
    ...
    \hline    
    1. Systémové volání: && \\ Vyvolání přerušení; && \\
    & 2. Kernel mód: & \\ & Skok na obsluhu přerušení; & \\
    && 3. Obsluha přerušení:  \\ && Dekódování přerušení a spuštění odpovídající rutiny OS;\\ && Návrat z OS; \\
    & 4. User mód: & \\ & Návrat z obsluhy; & \\
    5. Obnova běhu; && \\
    \end{tabularx}
...
\begin{table}
    ...
    \hline
    1. Systémové volání: && \\ Vyvolání přerušení; && \\
    && 2. Obsluha přerušení: \\ && Skok na obsluhu přerušení odpovídajícího OS (snížení privilegií) \\    
    & 3. Obsluha přerušení: & \\ & Dekódování přerušení a obsloužení systémového volání; & \\ & Návrat z OS; & \\
    && 4. Obsluha ukončena: \\ && Provedení reálného návratu;\\
    5. Obnova běhu; &&\\
    \end{tabularx}
